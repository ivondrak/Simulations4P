...
class SimulationApp:
    ...
    def show(self):
        ...
        self.server.show()
        self.sink.show()
        Histogram(self.arrivals.data, "Arrivals time disttibution","Arrival Time","Frequency").plot()
        Histogram(self.services.data, "Service time disttibution","Service Time","Frequency").plot()
        Histogram(self.spent_time, "Spent time disttibution","Time spent in a system","Frequency").plot()